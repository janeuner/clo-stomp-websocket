...
//C:\\CLO\\ClientGUI\\Board Resized.jpeg
    ...
    ScarletStart("Scarlet Piece.png", new Area(new Rectangle(230,415,175,125)), 255, 470),
    ColMustardStart("Mustard Piece.png", new Area(new Rectangle(430,50,155,125)), 460, 105),
    MrsWhiteStart("White Piece.png", new Area(new Rectangle(450,435,140,140)), 460, 490),
    MrGreenStart("Green Piece.png", new Area(new Rectangle(40,300,140,105)), 55, 340),
    MrsPeacockStart("Peacock Piece.png", new Area(new Rectangle(40,455,140,110)), 55, 490),
	ProfPlumStart("Plum Piece.png", new Area(new Rectangle(40,50,160,90)), 55, 75);
...
GameEntityID(String fileURL, Area boundary, int xposition, int yposition){
	this.boundary = boundary;
	this.xposition = xposition;
	this.yposition = yposition;
	this.name = name;
	this.image = new ImageIcon("C:\\CLO\\Gamepieces\\" + fileURL);
...
GameEntityID(String name, int type){
	...
	this.type = type;
	   switch (type){
       case 1:     //Weapon
           image = new ImageIcon("C:\\CLO\\Weapons\\" + name + ".jpg");
           break;

       case 2:     //Location
           image = new ImageIcon("C:\\CLO\\Locations\\" + name + ".jpg");
           break;

       case 3:     //Suspect
           image = new ImageIcon("C:\\CLO\\Suspects\\" + name + ".jpg");
           break;
   }
}
...
public Area getBoundaryBox() {return boundary;}
